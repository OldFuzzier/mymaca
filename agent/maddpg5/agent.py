...
if IS_DISPERSED:
    from agent.maddpg5.maddpg_dispersed import MADDPG
else:
    from agent.maddpg5.maddpg import MADDPG
...
class Agent(BaseAgent):
    def __init__(self):
        ...
        self.obs_ind = 'maddpg5'
        if not os.path.exists('model/{}/{}0.pkl'.format(MODEL_PATH, MODEL_NAME)):
            logger.info('Error: agent maddpg5 model data not exist!')
            exit(1)
