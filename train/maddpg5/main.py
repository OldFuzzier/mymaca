...
from train.maddpg5.MADDPG import MADDPG
        ...
        while True:
            ...
            for y in range(red_fighter_num):
                ...
                if step_cnt > STEP_BEFORE_TRAIN:
                    ...
                    # g_striking_pos = tmp_g_striking_pos.reshape(1, -1)[0] / size_x  # (20, )
                    striking_id = tmp_striking_id.reshape(1, -1)[0] / 1
                    obs = np.concatenate(
                        (course, pos, l_missile, s_missile, r_visible_pos, j_visible_dir, tmp_striking_id), axis=0)
