...
from train.maddpg3.memory import ReplayMemory, Experience
from config import GPU_CONFIG, logger, IS_DISPERSED

if IS_DISPERSED:
    from train.maddpg3.model_dispersed import Critic, Actor
else:
    from train.maddpg3.model import Critic, Actor
    ...
    def update_policy(self):
        ...
        if self.learn_step_counter > 0 and self.learn_step_counter % self.replace_target_iter == 0:  # todo
            ...
            for i in range(self.n_agents):
                ...
                model_name = 'model/maddpg3/model_{}_agent{}.pkl'.format(step_counter_str, i)
