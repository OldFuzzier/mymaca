...
from train.self_learn.MADDPG import MADDPG
...
if __name__ == '__main__':
    ...
    blue_agent_obs_ind = AGENT_NAME  # blue agent
    # init model
        ...
        while True:
            ...
            for obs_dict in obs_dict_list:
                for y in range(red_fighter_num):
                    ...
                    if not obs_dict['fighter'][y]['alive']:
            ...
            # env step
            logger.info('agent0 true action: {}'.format(fighter_action[0]))  # test
            red_fighter_action = np.array(fighter_action[:10])
            blue_fighter_action = np.array(fighter_action[10:])
            ...
            if step_cnt > STEP_BEFORE_TRAIN:
                ...
                total_reward += red_fighter_reward.sum()
                rr += red_fighter_reward
            ...
            if step_cnt > STEP_BEFORE_TRAIN:
                ...
                maddpg.memory.push(obs_list[10:], action_list[10:], next_obs_list[10:], blue_fighter_reward)
