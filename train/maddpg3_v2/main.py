...
from train.maddpg3_v2.MADDPG import MADDPG
from interface import Environment
from agent.fix_rule.agent import Agent  # todo 更改规则模型
# from agent.maddpg3_v2.agent import Agent
...
STEP_BEFORE_TRAIN = 100  # 前多少步不需要 100
BATCH_SIZE = 256  # 256
...
AGENT_NAME = 'maddpg3_v2'
# obs: 自身坐标，自身航向，主动观测列表坐标，被动观测航向，打击列表，全局观测坐标
