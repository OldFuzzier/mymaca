...
from train.maddpg2.memory import ReplayMemory, Experience
from config import GPU_CONFIG, logger, IS_DISPERSED, MODEL_PATH

if IS_DISPERSED:
    from train.maddpg2.model_dispersed import Critic, Actor
else:
    from train.maddpg2.model import Critic, Actor
