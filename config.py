...
# model agent name
MODEL_NAME = 'model_000015500_agent'
# MODEL_NAME_AGENT = 'model_000029900_agent'  # maddpg
MODEL_NAME_AGENT = 'model_de_game_rwd_000025000'  # dqn， 防守，vs MidSolo
# maddpg4/v3 model_000029900_agent:  # maddpg偏角+规则， 进攻， 奖励图，vs fix_rule
# maddpg4_stable model_000035050_agent:  # maddgp偏角+规则，防守，vs MidSolo

# model store path
MODEL_PATH = 'maddpg4/v3'
# model agent path
MODEL_PATH_AGENT = 'dqn_sjy'

# pics path or ''
PICS_PATH = 'maddpg4/v2'
